...
namespace Hotel {
    ...
    public partial class AllEmployeeDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeeRow AddEmployeeRow(int ID, string Name, string Email, string Password, string Phone, string Address, string DOB, string BG, string JoiningDate, string Salary, string EmpType, byte[] Image) {
...
namespace Hotel.AllEmployeeDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employee] ([ID], [Name], [Email], [Password], [Phone], [Address], [DOB], [BG], [JoiningDate], [Salary], [EmpType], [Image]) VALUES (@ID, @Name, @Email, @Password, @Phone, @Address, @DOB, @BG, @JoiningDate, @Salary, @EmpType, @Image);
SELECT SN, ID, Name, Email, Password, Phone, Address, DOB, BG, JoiningDate, Salary, EmpType, Image FROM Employee WHERE (SN = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [ID] = @ID, [Name] = @Name, [Email] = @Email, [Password] = @Password, [Phone] = @Phone, [Address] = @Address, [DOB] = @DOB, [BG] = @BG, [JoiningDate] = @JoiningDate, [Salary] = @Salary, [EmpType] = @EmpType, [Image] = @Image WHERE (([SN] = @Original_SN) AND ((@IsNull_ID = 1 AND [ID] IS NULL) OR ([ID] = @Original_ID)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_DOB = 1 AND [DOB] IS NULL) OR ([DOB] = @Original_DOB)) AND ((@IsNull_BG = 1 AND [BG] IS NULL) OR ([BG] = @Original_BG)) AND ((@IsNull_JoiningDate = 1 AND [JoiningDate] IS NULL) OR ([JoiningDate] = @Original_JoiningDate)) AND ((@IsNull_Salary = 1 AND [Salary] IS NULL) OR ([Salary] = @Original_Salary)) AND ((@IsNull_EmpType = 1 AND [EmpType] IS NULL) OR ([EmpType] = @Original_EmpType)));
SELECT SN, ID, Name, Email, Password, Phone, Address, DOB, BG, JoiningDate, Salary, EmpType, Image FROM Employee WHERE (SN = @SN)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT SN, ID, Name, Email, Password, Phone, Address, DOB, BG, JoiningDate, Salar" +
                "y, EmpType, Image FROM dbo.Employee";
        ...
        public virtual int Insert(global::System.Nullable<int> ID, string Name, string Email, string Password, string Phone, string Address, string DOB, string BG, string JoiningDate, string Salary, string EmpType, byte[] Image) {
            if ((ID.HasValue == true)) {
            ...
            if ((EmpType == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[10].Value = ((string)(EmpType));
            }
            if ((Image == null)) {
        ...
        public virtual int Update(
            ...
            if ((EmpType == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(EmpType));
            }
            if ((Image == null)) {
            ...
            if ((Original_Salary == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[32].Value = ((string)(Original_Salary));
            }
            if ((Original_EmpType == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_Salary, 
                    string Original_EmpType) {
            return this.Update(ID, Name, Email, Password, Phone, Address, DOB, BG, JoiningDate, Salary, EmpType, Image, Original_SN, Original_ID, Original_Name, Original_Email, Original_Password, Original_Phone, Original_Address, Original_DOB, Original_BG, Original_JoiningDate, Original_Salary, Original_EmpType, Original_SN);
        }
    }
